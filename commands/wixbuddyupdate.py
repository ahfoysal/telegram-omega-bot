...
TARGET_GROUP_CHAT_ID = -4777991175


async def wix_update_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("✅ Your Update message has been sent to the Wix Buddy central update group.")
